...
export default function DashboardAppPage() {
  ...
  const calculateAverageTime = async () => {
    try {
      const response = await fetch('https://missing-professor-backend-ankitrout2903.vercel.app/users'); // Fetch users data from localhost:3001/user
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6} lg={8}>
            <AppWebsiteVisits
              ...
              subheader="subtitle"
              chartLabels={[
                'Clue 1 Pattern Solving',
                'Clue 2 Memory and Recall',
                'Clue 3 Visual Spatial Reasoning',
                'Clue 4 Critical Thinking',
                'Clue 5 Analytical Thinking',
